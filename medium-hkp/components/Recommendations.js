...
const styles = {
    ...
    searchInput: "border-none outline-none bg-none w-full bg-inherit",
    ...
    recommendationThumbnailContainer: `flex-1 flex items-center justify-center h-[4rem] w-[4rem]`,
...
const Recommendations = () => {
    return (
        <div className={styles.wrapper}>
            <div className={styles.accentedButton}>Get unlimite access</div>
            ...
            <div className={styles.authorContainer}>
                <div className={styles.authorProfileImageContainer}>
                    <Image src={Qazi} height={100} width={100} alt={""} />
                </div>
                <div className={styles.authorName}>Phat Huynh</div>
                    ...
                    {recommendationPosts.map((post) => (
                        ...
                        >
                            <div className={styles.articleContent}>
                                <div
                                    className={
                                        styles.recommendationAuthorContainer
                                    }
                                >
                                    <div
                                        className={
                                    ...
                                    <div
                                        className={
                                            styles.recommendationAuthorName
                                        }
                                    >
                                        {post.author.name}
                                    </div>
                            ...
                            <div
                                className={
                                    styles.recommendationThumbnailContainer
                                }
                            >
                                <Image
                                    src={post.image}
...
const recommendationPosts = [
    ...
    {
        id: "2",
        title: "The Ultimate JavasScript Course for Beginners by Clever Programmer",
        image: TutorialImg,
        author: {
            name: "HKP",
            image: Qazi,
